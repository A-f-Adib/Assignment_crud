  ...
  <body>
    <div class="main-block">
      ...
      <form action="#" method="POST">
       ...
       <input type="submit" value="register" name="submit" placeholder="save"> 
        <!-- <button type="submit" name="submitt" href="/">Submit</button> -->
      </form>
    </div>
  </body>
</html>
     ...
     $email = $_POST['email'];
      $phn = $_POST['phn'];
       $pwd = $_POST['pwd'];
        ...
        $query = "INSERT INTO form values('$fname','$email','$phn','$pwd','$course')"; 
